            ...
            <div class="modal-body">
              <form method="POST" action="{{ route('imc.update',['id' => $imc->id])}}">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail3" name="novo_nome" value="{{$imc->nome}}">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputEmail3" class="col-sm-2 col-form-label" placeholder="Peso">Peso</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail3" name="novo_peso" value="{{$imc->peso}}">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputPassword3" class="col-sm-2 col-form-label" placeholder="Altura">Altura</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputPassword3" name="novo_altura" value="{{$imc->altura}}">
                  </div>
                </div>
